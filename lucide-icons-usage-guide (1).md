---
name: Lucide Icons Usage
description: "Guide for using Lucide icons — import syntax, sizing, color, icon-only vs labeled, accessibility, and choosing the right icon. Use when writing or reviewing UI code that includes icons."
---
